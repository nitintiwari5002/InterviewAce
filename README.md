<p align="center">
  <img width="200" height="200" alt="Image" src="https://github.com/user-attachments/assets/05a7e0c9-8aba-4f5b-a4b2-7be90d886b7d" />
</p>
...
```
## **3️⃣ Get the API from groq**

```bash
Select the model and get the API as per the requirements
``` 
